...
- VPS (виртуальный сервер) или отдельный сервер с Ubuntu;
...
Установщик сохраняет существующий файл `.env`, добавляет недостающие параметры из новой версии примера настроек, проверяет Docker Compose и запускает обновлённые контейнеры.
...
Удалить приложение, сохранив данные Docker:
