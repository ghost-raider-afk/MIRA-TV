...
export function loadConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    weatherGeocodingUrl: required('WEATHER_GEOCODING_URL', env.WEATHER_GEOCODING_URL),
    weatherForecastUrl: required('WEATHER_FORECAST_URL', env.WEATHER_FORECAST_URL),
    weatherCacheSeconds: integer('WEATHER_CACHE_SECONDS', env.WEATHER_CACHE_SECONDS, { minimum: 60, maximum: 86400 }),
    weatherRequestTimeoutMs: integer('WEATHER_REQUEST_TIMEOUT_MS', env.WEATHER_REQUEST_TIMEOUT_MS, { minimum: 500, maximum: 30000 }),
    weatherCacheMaxEntries: integer('WEATHER_CACHE_MAX_ENTRIES', env.WEATHER_CACHE_MAX_ENTRIES, { minimum: 10, maximum: 10000 }),
    weatherPlayerRefreshSeconds: integer('WEATHER_PLAYER_REFRESH_SECONDS', env.WEATHER_PLAYER_REFRESH_SECONDS, { minimum: 300, maximum: 86400 }),
    ...
    mediaImageMaxBytes: integer('MEDIA_IMAGE_MAX_BYTES', env.MEDIA_IMAGE_MAX_BYTES, { minimum: 1048576, maximum: 104857600 }),
    mediaVideoMaxBytes: integer('MEDIA_VIDEO_MAX_BYTES', env.MEDIA_VIDEO_MAX_BYTES, { minimum: 1048576, maximum: 1073741824 }),
    mediaMaxWidth: integer('MEDIA_MAX_WIDTH', env.MEDIA_MAX_WIDTH, { minimum: 320, maximum: 16384 }),
    mediaMaxHeight: integer('MEDIA_MAX_HEIGHT', env.MEDIA_MAX_HEIGHT, { minimum: 240, maximum: 8192 }),
    mediaMaxPixels: integer('MEDIA_MAX_PIXELS', env.MEDIA_MAX_PIXELS, { minimum: 262144, maximum: 134217728 }),
