...
export function animationProfileInput(source) {
  ...
  return {
    ...
    promotion_badge_glow_enabled: profile.promotion_badge_glow_enabled === true,
    promotion_badge_shine_enabled: profile.promotion_badge_shine_enabled === true,
    promotion_badge_sparkle_enabled: profile.promotion_badge_sparkle_enabled === true,
    promotion_row_highlight_enabled: profile.promotion_row_highlight_enabled === true,
    promotion_row_animation_enabled: profile.promotion_row_animation_enabled === true,
