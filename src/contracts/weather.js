...
export function completeWeatherWidget(source = {}) {
  ...
  return {
    ...
    animation_enabled: booleanValue(value.animation_enabled, DEFAULT_WEATHER_WIDGET.animation_enabled),
    animation_speed: numberValue(value.animation_speed, DEFAULT_WEATHER_WIDGET.animation_speed, 0.25, 2),
    animation_intensity: numberValue(value.animation_intensity, DEFAULT_WEATHER_WIDGET.animation_intensity, 0.25, 2),
    widget_motion_enabled: booleanValue(value.widget_motion_enabled, DEFAULT_WEATHER_WIDGET.widget_motion_enabled),
