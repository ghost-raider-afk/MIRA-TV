...
function canonicalCurrent(source) {
  return {
    ...
    menu_visible: source.menu_visible !== false,
    promotion_visible: source.promotion_visible !== false,
    ...
    promotion_badge_glow_enabled: source.promotion_badge_glow_enabled !== false,
    promotion_badge_shine_enabled: source.promotion_badge_shine_enabled !== false,
    promotion_badge_sparkle_enabled: source.promotion_badge_sparkle_enabled !== false,
    promotion_row_highlight_enabled: source.promotion_row_highlight_enabled !== false,
    promotion_row_animation_enabled: source.promotion_row_animation_enabled !== false,
