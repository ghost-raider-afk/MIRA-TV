const RETIRED_SHELL_CACHE = 'mira-tv-player-shell-v37';
const LEGACY_SHELL_CACHE = 'mira-tv-player-shell-v38';
const SHELL_CACHE = 'mira-tv-player-shell-v39';
const DATA_CACHE = 'mira-tv-player-data-v18';
// Source revision: weather typography controls and bundled font expansion.
const SHELL_ASSETS = [
  '/player.html',
  '/css/fonts.css',
