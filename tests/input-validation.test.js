...
function runtimeEnv(overrides = {}) {
  return {
    APP_NAME: 'MIRA-TV', MIRA_TV_VERSION: '1.0.0', NODE_ENV: 'test', HOST: '127.0.0.1', PORT: '8080', MIRA_TV_DOMAIN: 'mira.example.test',
    ...
    SITE_ASSETS_ROOT: '/tmp/mira-tv-assets', SITE_LOGO_MAX_BYTES: '2097152', SITE_FAVICON_MAX_BYTES: '524288', SCREEN_BACKGROUND_MAX_BYTES: '20971520', ENTITY_ASSET_MAX_BYTES: '104857600',
    MEDIA_IMAGE_MAX_BYTES: '20971520', MEDIA_VIDEO_MAX_BYTES: '262144000', MEDIA_MAX_WIDTH: '11520', MEDIA_MAX_HEIGHT: '4320', MEDIA_MAX_PIXELS: '50000000',
    HEALTH_READINESS_CACHE_MS: '2000',
    POSTGRES_HOST: 'db', POSTGRES_PORT: '5432', POSTGRES_DB: 'mira_tv', POSTGRES_USER: 'mira_tv', POSTGRES_PASSWORD: 'p'.repeat(32), POSTGRES_POOL_MAX: '5', POSTGRES_CONNECTION_TIMEOUT_MS: '5000', POSTGRES_IDLE_TIMEOUT_MS: '30000',
